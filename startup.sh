...
if [ ! -d "target" ] || [ ! -f "target/classes/com/example/api_veiculos1/ApiVeiculos1Application.class" ]; then
...
while [ $ELAPSED -lt $TIMEOUT ]; do
    if grep -q "Started ApiVeiculos1Application" "$LOG_FILE" 2>/dev/null; then
        echo ""
